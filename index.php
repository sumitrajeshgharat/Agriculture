...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-wEmeIV1mKuiNpC+IOBjI7aAzPcEZeedi5yW5f2yOq55WWLwNGmvvx4Um1vskeMj0" crossorigin="anonymous">
	...
	?>
		...
		<center>
			<h1 style="font-size:35px; font-weight:700; color:Red">About Us</h1>
		</center>
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">AgroFarma &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:Yellow">Your product Our market !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px; color:Yellow">AgroFarma<span>INDIA</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px; color:Yellow">123456789</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px; color:Yellow"><a href="mailto:agzone@gmail.com" style="color:Yellow">agrofarma@xyz.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px;"><b>About AgZone</b></span>
				AgZone is e-commerce trading platform for grains & grocerries...
			</p>
			<div class="footer-icons">
				<a  href="#"><i style="color:blue;text-decoration: none; margin-left: 0;margin-top:5px;"class="fa fa-facebook"></i></a>
				<a href="#"><i style="color:#FC67F5;text-decoration: none; margin-left: 0;margin-top:5px" class="fa fa-instagram"></i></a>
				<a href="#"><i style="color:red;text-decoration: none; margin-left: 0;margin-top:5px" class="fa fa-youtube"></i></a>
			</div>
		</div>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="farmer" name="category1" value="1" checked>
				                            <label for="farmer">Farmer</label>
				                        </div>
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="buyer" name="category1" value="0">
